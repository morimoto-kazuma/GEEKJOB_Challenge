...
public class InsertConfirm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            userbeans.setName((String) session.getAttribute("name"));
            userbeans.setYear(year);
            userbeans.setMonth(month);
            userbeans.setDay(day);
            userbeans.setType(Integer.parseInt((String) session.getAttribute("type")));
            userbeans.setTell((String) session.getAttribute("tell"));
            userbeans.setComment((String) session.getAttribute("comment"));
